...
export default function BannerReserve() {
    ...
    return(
        ...
        <a className="inline-flex items-center bg-luxury-black text-white px-10 py-4 rounded-full font-bold text-lg hover:scale-105 transition-transform" href="https://wa.me/50369303080" target="_blank" rel="noopener noreferrer">
